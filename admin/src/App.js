...
const App = () => (
  ...
  >
    ...
    <Resource
      name="lighthouse"
      title="Lighthouse"
      options={{ title: "lighthouse", label: "Lighthouse" }}
      list={LighthouseList}
      show={LighthouseShow}
      edit={LighthouseEdit}
      create={LighthouseCreate}
    />
    <Resource
      name="lighthouse_details"
      title="Lighthouse"
      options={{ title: "lighthouse", label: "Lighthouse Results" }}
      list={LighthouseResultsList}
      show={LighthouseResultsShow}
    />
    <Resource
      name="keywords/yake"
      options={{ label: "Yake" }}
    ...
    <Resource
      name="security"
      title="Security"
      options={{ title: "security", label: "Security" }}
      list={SecurityList}
      show={SecurityShow}
      edit={SecurityEdit}
    ...
    <Resource
      ...
      title="Security"
      options={{ title: "security", label: "Security Results" }}
      list={SecurityResultsList}
      show={SecurityResultsShow}
    />
  </Admin>
);
